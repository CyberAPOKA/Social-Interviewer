        ...
        <div class="sidebar-content">
            <ul class="nav nav-primary">
                ...
                <li class="nav-item">
                    ...
                    <div class="expandable collapse {{ (request()->routeIs('candidatos.index')) || (request()->routeIs('pdf')) ? 'show' : '' }}"
                        aria-controls="collapseOne" id="base">
                        <ul class="nav nav-collapse ">
                           
                            <li class="{{ (request()->routeIs('candidatos.index')) ? 'active' : '' }}">
                                <a href="{{ route('candidatos.index') }}">
                                    <span class="sub-item">Lista</span>
                                </a>
                            </li>
                            
                            <li class="{{ (request()->routeIs('candidatos.audit')) ? 'active' : '' }}">
                                <a href="{{ route('candidatos.audit') }}">
